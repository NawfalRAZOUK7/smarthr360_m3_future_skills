...
FUTURE_SKILLS_ASYNC_PREDICTIONS = True
FUTURE_SKILLS_DRIFT_WARNING_THRESHOLD = 5.0
FUTURE_SKILLS_DRIFT_CRITICAL_THRESHOLD = 10.0
...
AUTH_JWT_SHARED_SECRET = config("AUTH_JWT_SHARED_SECRET", default="")
