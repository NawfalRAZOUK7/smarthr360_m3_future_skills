...
def skills_gap_scenario(db):
    ...
    future_skills = [
        FutureSkill.objects.create(
            skill_name=SKILL_AI_ML, category="Technical", importance_score=0.95, relevance_score=0.90
        ),
        FutureSkill.objects.create(
            skill_name=SKILL_CLOUD_ARCHITECTURE, category="Technical", importance_score=0.88, relevance_score=0.85
        ),
        FutureSkill.objects.create(
            skill_name="Leadership", category="Soft Skills", importance_score=0.82, relevance_score=0.80
        ),
    ]
