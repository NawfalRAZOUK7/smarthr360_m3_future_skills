...
def regular_user(db):
    ...
    user = User.objects.create_user(
        username="testuser", email="testuser@example.com", password="testpass123", is_staff=False, is_superuser=False
    )
...
def hr_manager(db):
    ...
    user = User.objects.create_user(
        username="hr_manager", email="hr_manager@example.com", password="hrpass123", is_staff=True
    )
...
def hr_viewer(db):
    ...
    """
    user = User.objects.create_user(
        username="hr_viewer", email="hr_viewer@example.com", password="viewerpass123", is_staff=False
    )
...
def sample_skill(db):
    ...
    return Skill.objects.create(
        name="Python Programming", category="Technical", description="Advanced Python programming skills"
    )
...
def sample_job_role(db):
    ...
    return JobRole.objects.create(
        name="Software Engineer", department="Engineering", description="Develops and maintains software applications"
    )
...
def sample_prediction_run(db):
    ...
    return PredictionRun.objects.create(
        description="Test prediction run", total_predictions=10, parameters={"horizon_years": 5, "engine": "rules"}
    )
...
def skill_data():
    ...
    """
    return {"name": SKILL_MACHINE_LEARNING, "category": "Technical", "description": "ML algorithms and frameworks"}
...
def job_role_data():
    ...
    """
    return {"name": "Data Analyst", "department": "Data Science", "description": "Analyzes data and provides insights"}
