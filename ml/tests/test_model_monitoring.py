...
class TestModelMonitoring:
    ...
    def test_multiple_predictions_logging(self, tmp_path, settings):
        ...
        predictions = [
            ...
            {"job_role_id": 2, "skill_id": 6, "predicted_level": "MEDIUM", "score": 55.0, "engine": "rules"},
            {"job_role_id": 3, "skill_id": 7, "predicted_level": "LOW", "score": 25.0, "engine": "ml"},
        ]
    ...
    def test_score_rounding(self, tmp_path, settings):
        ...
        _log_prediction_for_monitoring(job_role_id=1, skill_id=5, predicted_level="HIGH", score=85.6789, engine="ml")
    ...
    def test_empty_features(self, tmp_path, settings):
        ...
        _log_prediction_for_monitoring(job_role_id=1, skill_id=5, predicted_level="HIGH", score=85.0, engine="rules")
    ...
    def test_none_model_version(self, tmp_path, settings):
        ...
        _log_prediction_for_monitoring(
            job_role_id=1, skill_id=5, predicted_level="HIGH", score=85.0, engine="rules", model_version=None
        )
    ...
    def test_rules_engine_logging(self, tmp_path, settings):
        ...
        _log_prediction_for_monitoring(
            job_role_id=10, skill_id=20, predicted_level="MEDIUM", score=55.0, engine="rules_v1"
        )
    ...
    def test_ml_engine_logging_with_features(self, tmp_path, settings):
        ...
        features = {"trend_score": 0.85, "internal_usage": 0.75, "training_requests": 0.65, "scarcity_index": 0.55}
...
class TestMonitoringIntegration:
    ...
    def test_jsonl_format(self, tmp_path, settings):
        ...
        for i in range(5):
            _log_prediction_for_monitoring(
                job_role_id=i, skill_id=i + 10, predicted_level="HIGH", score=80.0 + i, engine="ml"
            )
