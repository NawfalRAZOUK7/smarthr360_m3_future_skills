...
class MLflowConfig:
    ...
    def _get_artifact_location(self) -> str:
        ...
        artifact_location = os.environ.get(
            "MLFLOW_ARTIFACT_LOCATION", getattr(settings, "MLFLOW_ARTIFACT_LOCATION", None)
        )
    ...
    def _get_backend_store_uri(self) -> str:
        ...
        """
        backend_uri = os.environ.get("MLFLOW_BACKEND_STORE_URI", getattr(settings, "MLFLOW_BACKEND_STORE_URI", None))
    ...
    def get_best_run(
        self, experiment_name: Optional[str] = None, metric_name: str = "accuracy", ascending: bool = False
    ) -> Optional[Any]:
        """
