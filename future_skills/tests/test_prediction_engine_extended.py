...
class TestEstimateInternalUsage(TestCase):
    ...
    def test_manager_role_gets_higher_usage(self):
        ...
        manager = JobRole.objects.create(
    ...
    def test_non_manager_role_gets_lower_usage(self):
        ...
        engineer = JobRole.objects.create(
...
class TestPredictionEngineBatchPredict(TestCase):
    ...
    def setUp(self):
        self.job_role1 = JobRole.objects.create(
            name="Data Scientist",
            department="IT"
        )
...
class TestLogPredictionForMonitoring(TestCase):
    ...
    @override_settings(FUTURE_SKILLS_ENABLE_MONITORING=True)
    @patch('future_skills.services.prediction_engine.open', side_effect=IOError("Disk full"))
...
class TestRecalculatePredictionsExtended(TestCase):
    ...
    def setUp(self):
        ...
        self.skill_java = Skill.objects.create(
            name="Java",
            category="Technique"
        )
        ...
        self.job_dev = JobRole.objects.create(
            name="Developer",
            department="IT"
        )
        MarketTrend.objects.create(
