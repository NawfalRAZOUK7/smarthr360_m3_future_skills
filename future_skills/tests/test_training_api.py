...
class TrainingAPITest(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="test_hr", password="testpass123", email="hr@test.com", is_staff=True
        )
    ...
    def test_validation(self):
        ...
        response = self.client.post("/api/training/train/", {"hyperparameters": {"n_estimators": 5000}}, format="json")
