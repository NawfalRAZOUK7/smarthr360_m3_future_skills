...
def train_model_task(self, training_run_id, dataset_path, test_split, hyperparameters):
    ...
    self.update_state(state="PROGRESS", meta={"stage": "initializing", "training_run_id": training_run_id})
    ...
    try:
        ...
        self.update_state(state="PROGRESS", meta={"stage": "loading_data", "training_run_id": training_run_id})
        ...
        # === STEP 3: Train model ===
        self.update_state(state="PROGRESS", meta={"stage": "training", "training_run_id": training_run_id})
        ...
        self.update_state(state="PROGRESS", meta={"stage": "evaluating", "training_run_id": training_run_id})
        ...
        self.update_state(state="PROGRESS", meta={"stage": "saving_model", "training_run_id": training_run_id})
        ...
        self.update_state(state="PROGRESS", meta={"stage": "updating_database", "training_run_id": training_run_id})
        ...
        # Update task state
        self.update_state(state="FAILURE", meta={"error": error_message, "training_run_id": training_run_id})
