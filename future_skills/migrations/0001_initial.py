...
"""Initial migration creating core Future Skills models."""
...
class Migration(migrations.Migration):
    """Create initial database schema for the future_skills app."""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "horizon_years",
                    models.PositiveIntegerField(help_text="Horizon de prédiction en années (ex : 3, 5...)."),
                ),
                (
                    "score",
