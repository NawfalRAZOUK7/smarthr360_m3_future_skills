...
"""Add HRInvestmentRecommendation model for HR guidance."""
...
class Migration(migrations.Migration):
    """Create HRInvestmentRecommendation model and dependencies."""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "horizon_years",
                    models.PositiveIntegerField(help_text="Horizon temporel de la recommandation (en années)."),
                ),
                (
                    "priority_level",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("TRAINING", "Investir en formation"),
                            ("HIRING", "Recruter de nouveaux talents"),
                            ("RESKILL", "Reskilling interne"),
                        ],
