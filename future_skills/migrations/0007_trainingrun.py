    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_version', models.CharField(help_text="Version identifier for the trained model (e.g., 'v1', 'v2.1').", max_length=50)),
                ('model_path', models.CharField(help_text='File system path where the model was saved.', max_length=500)),
                ('dataset_path', models.CharField(blank=True, help_text='Path to the training dataset CSV file.', max_length=500, null=True)),
                ...
                ('per_class_metrics', models.JSONField(blank=True, default=dict, help_text='Per-class accuracy and support counts (LOW, MEDIUM, HIGH).')),
                ('features_used', models.JSONField(blank=True, default=list, help_text='List of features used for training.')),
                ('notes', models.TextField(blank=True, help_text='Additional notes or comments about this training run.', null=True)),
                ('trained_by', models.ForeignKey(blank=True, help_text='User who triggered the training (null if CLI).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='training_runs', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Training Run',
                'verbose_name_plural': 'Training Runs',
                'ordering': ['-run_date'],
                'indexes': [models.Index(fields=['-run_date'], name='future_skil_run_dat_205663_idx'), models.Index(fields=['model_version'], name='future_skil_model_v_7f9524_idx')],
            },
        ),
    ]
