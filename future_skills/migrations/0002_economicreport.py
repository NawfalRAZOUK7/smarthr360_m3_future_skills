...
"""Add EconomicReport model for storing economic indicators."""

from django.db import migrations, models


class Migration(migrations.Migration):
    """Create the EconomicReport model."""
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.FloatField(help_text="Valeur de l’indicateur (pourcentage, indice, budget…)."),
                ),
                (
                    "sector",
                    models.CharField(
