...
case $COMMAND in
    "retrain")
        ...
        python ml/scripts/retrain_model.py --version "$VERSION"
    ...
    "train")
        ...
        python ml/scripts/train_future_skills_model.py --csv artifacts/datasets/future_skills_dataset.csv --output artifacts/models/future_skills_model.pkl --version "$VERSION"
